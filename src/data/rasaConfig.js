...
const rasaConfig = {
  ...
  shringara: {
    ...
    shlokas: [
      {
        sanskrit: 'रसानां प्रथमः श्ृङ्गारः।',
        transliteration: 'Rasānāṃ prathamaḥ śṛṅgāraḥ',
        translation: 'Of all Rasas, Shringara is the first — for love is the origin of all feeling.',
        source: 'Natyashastra',
      },
      {
        sanskrit: 'आत्मा वा अरे द्रष्टव्यः।',
        transliteration: 'Ātmā vā are draṣṭavyaḥ',
        translation: 'The Self alone is worthy of seeing, hearing, thinking upon, and meditating upon.',
        source: 'Brihadaranyaka Upanishad 2.4.5',
      },
    ],

    explorations: [
      'What do you love so deeply that it makes you ache?',
      'Close your eyes — who appears in the warmth behind your eyelids?',
      'Love is not possession. What would it mean to love and let go?',
    ],
  },
  ...
  hasya: {
    ...
    shlokas: [
      {
        sanskrit: 'हास्यं प्रीतिकरं लोके सर्वेषां प्राणिनां सदा।',
        transliteration: 'Hāsyaṃ prītikaraṃ loke sarveṣāṃ prāṇināṃ sadā',
        translation: 'Laughter brings delight to all beings in the world, always.',
        source: 'Natyashastra, Chapter 6',
      },
      {
        sanskrit: 'आनन्दो ब्रह्मेति व्यजानात्।',
        transliteration: 'Ānando brahmeti vyajānāt',
        translation: 'He realized that Bliss is Brahman — joy itself is the divine.',
    ...
    explorations: [
      'What would it feel like to laugh without reason — like a child?',
      'Where in your body do you feel joy? Is it warm? Light?',
      'Close your eyes and recall a moment of pure, innocent laughter.',
    ],
  },
  ...
  karuna: {
    ...
    shlokas: [
      {
        sanskrit: 'करुणा धर्मस्य मूलम्।',
        transliteration: 'Karuṇā dharmasya mūlam',
        translation: 'Compassion is the root of all dharma.',
        source: 'Vedic Wisdom',
      },
      {
        sanskrit: 'न जायते म्रियते वा कदाचित्। नायं भूत्वा भविता वा न भूयः।',
        transliteration: 'Na jāyate mriyate vā kadācit. Nāyaṃ bhūtvā bhavitā vā na bhūyaḥ',
        translation: 'The soul is never born and never dies. Having been, it will never cease to be.',
        source: 'Bhagavad Gita 2.20',
      },
      {
        sanskrit: 'सर्वभूतहिते रताः।',
        transliteration: 'Sarvabhūtahite ratāḥ',
        translation: 'Those who delight in the welfare of all beings.',
        source: 'Bhagavad Gita 5.25',
      },
    ],

    explorations: [
      'What is your sorrow trying to honor? What love does it carry?',
      'If you could speak to your grief, what would it say back?',
      'Place your hand on your heart. Feel its steady rhythm — it endures.',
    ],
  },
  ...
  raudra: {
    ...
    shlokas: [
      ...
      },
      {
        ...
        translation: 'Whenever dharma declines, I manifest to restore it.',
    ...
    explorations: [
      'What injustice has awakened this fire? Name it clearly.',
      'Is your anger protecting something precious? What is it?',
      'Feel the heat in your body — now breathe cool air through it.',
    ],
  },
  ...
  veera: {
    ...
    shlokas: [
      ...
      },
      {
        ...
        translation: 'On the field of dharma, on the field of action.',
        source: 'Bhagavad Gita 1.1',
      },
    ],

    explorations: [
      'What is your dharma right now? What must you face?',
      'Feel the strength in your spine. You are already a warrior.',
  ...
  bhayanaka: {
    ...
    shlokas: [
      {
        sanskrit: 'भयं द्वितीयाभिनिवेशतः।',
        transliteration: 'Bhayaṃ dvitīyābhiniveśataḥ',
        translation: 'Fear arises from seeing oneself as separate. In unity, fear dissolves.',
        source: 'Brihadaranyaka Upanishad 1.4.2',
      },
    ],

    explorations: [
      'Name your fear. When it has a name, it becomes smaller.',
      'What is the worst that could happen? And then what?',
      'You are the awareness witnessing the fear — you are not the fear.',
    ],
  },
    ...
    shlokas: [
      {
        ...
        transliteration: 'Vivekacūḍāmaṇi',
        translation: 'The crest-jewel of discernment — seeing clearly what is real and what is not.',
        source: 'Vivekachudamani by Adi Shankaracharya',
      },
    ],

    explorations: [
      'What are you no longer willing to accept? Trust that answer.',
      'Discernment is love in disguise — it protects what matters.',
      'Like the lotus in muddy water, clarity emerges from confusion.',
    ],
  },
  ...
  adbhuta: {
    ...
    shlokas: [
      {
        sanskrit: 'आश्चर्यवत् पश्यति कश्चिदेनम्।',
        transliteration: 'Āścaryavat paśyati kaściDenam',
        translation: 'Some see this Self as wondrous — this is the beginning of all understanding.',
        source: 'Bhagavad Gita 2.29',
      },
    ],

    explorations: [
      'When was the last time something truly astonished you?',
      'Look at your own hand. Really look. Is it not miraculous?',
      'The universe created you to witness itself. You are its eyes.',
    ],
  },
    ...
    shlokas: [
      {
        ...
        translation: 'Serene in form, resting upon the cosmic serpent, lotus-naveled lord of the gods, foundation of the universe.',
        source: 'Vishnu Dhyanam',
      },
      {
        sanskrit: 'योगस्थः कुरु कर्माणि सङ्गं त्यक्त्वा धनञ्जय।',
        transliteration: 'Yogasthaḥ kuru karmāṇi saṅgaṃ tyaktvā dhanañjaya',
        translation: 'Established in yoga, perform actions having abandoned attachment, O Arjuna.',
        source: 'Bhagavad Gita 2.48',
      },
      {
        sanskrit: 'ॐ सर्वे भवन्तु सुखिनः। सर्वे सन्तु निरामयाः। सर्वे भद्राणि पश्यन्तु। मा कश्चिद्दुःखभाग्भवेत्।',
        transliteration: 'Oṃ sarve bhavantu sukhinaḥ. Sarve santu nirāmayāḥ. Sarve bhadrāṇi paśyantu. Mā kaścidduḥkhabhāgbhavet',
        translation: 'May all be happy. May all be free from illness. May all see what is auspicious. May no one suffer.',
        source: 'Brihadaranyaka Upanishad',
      },
    ],

    explorations: [
      'Notice the space between your thoughts. What lives there?',
      'Can you hear the silence beneath all sounds? That is shanta.',
      'Feel the weight of your body, the rhythm of breath — you are already home.',
    ],
  },
};

// ─── UTILITY FUNCTIONS ───
// ===== HELPER: Get Rasa by emotion — IMPROVED =====
export function getRasaByEmotion(emotion, confidence) {
  // Happy — distinguish intensity
  if (emotion === 'happy') {
    if (confidence > 0.55) return rasaConfig.hasya;       // Strong joy
    return rasaConfig.shringara;                            // Gentle contentment
  }

  // Direct mappings
  if (emotion === 'sad') return rasaConfig.karuna;
  if (emotion === 'angry') return rasaConfig.raudra;
  if (emotion === 'fearful') return rasaConfig.bhayanaka;
  if (emotion === 'disgusted') return rasaConfig.bibhatsa;
  if (emotion === 'surprised') return rasaConfig.adbhuta;

  // Neutral — map to Shanta (peace), NOT Veera
  if (emotion === 'neutral') return rasaConfig.shanta;

  // Absolute fallback — wonder (complex blend)
  return rasaConfig.adbhuta;
}
